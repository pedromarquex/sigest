...
export function DirectSearchWithStainedMaterial() {
  const contentText = [
    "Lesões primárias e secundárias.",
    "Esfregaço em lâmina ou cortes histológicos com diferentes corantes.",
    "Todas as técnicas têm sensibilidade inferior à microscopia de campo escuro.",
  ...
  return (
    <Background style={styles.container}>
      <BodyContainer>
        <Title text="Pesquisa direta com material corado" />
